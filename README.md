...
An interactive, self-contained HTML reference for tensor calculus — built from first principles, with live visualizations and a margin for your own notes.

**→ [Read it on GitHub Pages](https://brona90.github.io/tensor-notebook/)**

## Contents

| § | Topic |
|---|-------|
| 1 | Vectors as equivalence classes of arrows |
| 2 | Linear algebra refresher: bases, inverses, change-of-basis |
| 3 | Contravariant transformation law |
| 4 | Covectors and the dual space |
...
Open `index.html` in any browser. No server, no install. Internet is needed once to fetch fonts and math rendering; the browser cache handles subsequent loads.

## License

Personal reference material. Use freely.
